...
describe('PATCH /todos/:id', () => {
  it ('should update to the todo', (done) => {
    ...
    var hexId = todos[0]._id.toHexString();
    var newText = "This is a new world order, yo.";
  ...
  it ('should not update to the todo created by another user', (done) => {
    // grab id of first item
    var hexId = todos[1]._id.toHexString();
    var newText = "This is a new world order, yo.";
...
describe('POST /users', () => {
  it('should create a user and return user', (done) => {
    var email = 'example@example.com';
    var password = '123msadf!';
  ...
  it('should return validation errors if password is invalid', (done) => {
    var emailgood = 'foo@bar.com';
    var passwordbad = '123';

    request(app)
      .post('/users')
      .send({emailgood, passwordbad})
      .expect(400)
      .expect((res) => {
  ...
  it('should return validation errors if email is invalid', (done) => {
    var emailbad = 'foo@bar';
    var passwordgood = '1234156';

    request(app)
      .post('/users')
      .send({emailbad, passwordgood})
      .expect(400)
      .expect((res) => {
        expect(res.body._message).toEqual('User validation failed');
      })
